...
| Provider                           | Cookies                                                                                                                            | Purpose                                                                                                                                                                                                                                                                                                                                                        | Data controller    | Retention                  |
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | -------------------------- |
| <p>.doubleclick.net</p><p><br></p> | IDE                                                                                                                                | Used by Google DoubleClick to register and report the site user's actions after viewing or clicking one of the advertiser's ads with the purpose of measuring the efficacy of an ad and to present targeted ads to the user.                                                                                                                                   | .doubleclick.net   | <p>300 days</p><p><br></p> |
| .doubleclick.net                   | test\_cookie                                                                                                                       | Test cookie used by Google DoubleClick to check that cookies can be set.                                                                                                                                                                                                                                                                                       | .doubleclick.net   | 1 day                      |
| Google Analytics                   | SSID, \_\_\_\_Secure-1PSIDCC, HSID, SAPISID, SID, SIDCC, APISID, SID, DV, OTZ, 1P\_JAR, AEC, SEARCH\_SAMESITE, NID, SOCS, \_\_cuid | Used by Google to create reports about users of the site. You can find out more about Google's use of information by visiting [https://www.google.com/policies/privacy/partners/ ](https://www.google.com/policies/privacy/partners/)and you can review Google's privacy policy at [https://policies.google.com/privacy](https://policies.google.com/privacy). | google.com, .co.uk | Mixed                      |
| \*.request.\*                      | \_ga                                                                                                                               | Google Analytics cookie used to collect information about how visitors use our Site.                                                                                                                                                                                                                                                                           | Request            | 730 days                   |
| \*.request.\*                      | \_gat\_\*                                                                                                                          | Google Analytics cookie used to collect information about how visitors use our Site.                                                                                                                                                                                                                                                                           | Request            | 1 minute                   |
